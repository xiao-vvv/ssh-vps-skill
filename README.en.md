...
It's just a little **skill**: one `SKILL.md` plus two self-contained bash scripts. Drop it into your AI agent and it learns how to keep all your little boxes tidy and secure — it runs on your own computer, nothing to install on the server side.
